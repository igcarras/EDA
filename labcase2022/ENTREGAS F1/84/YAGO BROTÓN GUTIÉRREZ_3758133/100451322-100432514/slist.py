...
This notebook implements a singly linked list, which saves the reference to the first node and the _size of the list.
"""
...
class SList:
    ...
    def __str__(self):
        ...
        while nodeIt is not None:  # nodeIt!=None
    ...
    def addLast(self, e):
        ...
        if self.isEmpty():
            ...
            # we move through the list until to reach the last node
            lastNode = self._head
