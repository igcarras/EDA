...
class Test(unittest.TestCase):
    ...
    def testInsertList2(self):
        print("\n\tinsertList2 end>=len(l1)")
        inputList=SList2()
        self.l.insertList(inputList,0,len(self.l))
        expected=self.data
        self.assertEqual(str(self.l), str(expected))
        print("\tinsertList2 end>=len(l1), ok!!!")
    ...
    def testInsertList5(self):
        ...
        expected=[10,10,10]
        self.assertEqual(str(self.l3), str(expected))
        print("\tinsertList5 start=0,end=len(l1)-1")
        
    def testInsertList6(self):
        print("\n\tinsertList6 start=0,end=len(l1)//2")
        ...
        self.assertEqual(str(self.l3), str(expected))
        print("\tinsertList6 start=0,end=len(l1)//2")
        
    def testInsertList7(self):
        print("\n\tinsertList7 start=len(l1)//2, end=len(l1)-1")
        ...
        self.assertEqual(str(self.l3), str(expected))
        print("\tinsertList7 start=len(l1)//2, end=len(l1)-1, ok")
        
    def testInsertList8(self):
        print("\n\tinsertList7 start=1, end=len(l1)-2")
        ...
        self.assertEqual(str(self.l3), str(expected))
        print("\tinsertList7 start=1, end=len(l1)-2, ok")
