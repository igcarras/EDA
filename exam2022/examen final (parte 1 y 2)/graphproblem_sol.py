...
class MyGraph:
    ...
    def _dfs(self, origin: str, visited: dict) -> None:
        """dfs traversal from v"""
        # Mark the current node as visited
        visited[origin] = True

        # Recur for all the vertices
        # adjacent to this vertex
        for adj in self._vertices[origin]:
            if not visited[adj]:
    ...
    def is_connected(self):
        ...
        # from first vertex: res = list(test_dict.keys())[0]
    ...
    def is_bridge(self, v1: str, v2: str) -> bool:
        ...
        if v1 not in self._vertices[v2]:
            print("({}, {}) is not an edge".format(v1, v2))
            return False
