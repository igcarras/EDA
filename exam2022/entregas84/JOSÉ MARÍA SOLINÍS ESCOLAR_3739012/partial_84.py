...
class MySList():
    ...
    def merge(self, other):
        ...
        while currentOther.next:
            if currentOther.elem == currentOther.next.elem:
                currentOther.next = currentOther.next.next
            currentOther = currentOther.next
        current = self._head
        aux = self._head.next
        currentOther = other._head
        auxOther = other._head.next
        while currentOther:
            print('hola')
            if current.elem == currentOther.elem:
                currentOther = currentOther.next
                auxOther = auxOther.next
            elif current.elem > currentOther.elem:
                currentOther.next = current
                currentOther = auxOther
                auxOther = auxOther.next
            else:
