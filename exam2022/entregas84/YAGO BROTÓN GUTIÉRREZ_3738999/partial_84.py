...
class MySList():
    ...
    def merge(self, other):
        ...
        while nodo1 and nodo2: # Mientras haya elementos en ambas vamos añadiendo
            if nodo1.elem == nodo2.elem:
                newList.append(nodo1.elem)
                nodo2 = nodo2.next
                nodo1 = nodo1.next

            elif nodo1.elem < nodo2.elem:
                newList.append(nodo1.elem)
                nodo1 = nodo1.next

            else:
                newList.append(nodo2.elem)
                nodo2 = nodo2.next

        while nodo1: # Ahora nos hemos quedado sin elementos en other, así que solo añadimos los nodos de self
            newList.append(nodo1.elem)
            nodo1 = nodo1.next

        while nodo2: # Caso contrario, solo hay elementos en la lista other
            newList.append(nodo2.elem)
            nodo2 = nodo2.next
