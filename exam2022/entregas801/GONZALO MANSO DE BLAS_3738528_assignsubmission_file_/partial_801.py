...
class MySList():
    ...
    def subtraction(self, other):
        ...
        l2 = MySList()
        if not self.isSorted() or not other.isSorted(): #si las listas están sin ordenar devuelve None

            return None

        else:
            aux = self._head            #hacemos dos punteros para cada una de las listas
            aux1 = other._head
            i = 0                       #hacemos dos contadores de salto para saber la posición de los punteros
            p = 0
            resultado = None
            while aux and aux1:
                    if i == 0:
                    ...
                    if p == 0:
                        return MySList
                    if i==p:
                        if aux.elem<aux1.elem:
                            resultado = aux1.elem - aux.elem
                            l2.append(resultado)
                        else:
                            resultado = aux.elem - aux1.elem
                            l2.append(resultado)
                    else:
                        if i<p:
                            l2.append(aux1)
