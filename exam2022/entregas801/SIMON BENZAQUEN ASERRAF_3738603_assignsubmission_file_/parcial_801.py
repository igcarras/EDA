#Resolución del primer parcial, alumno: Simón Benzaquén Aserraf, NIA: 100475237, grupo: 801
        ...
        if self.isSorted():
            if other.isSorted():
                ...
                while puntero_Otra:
                    ...
                    l_final.append(abs(resultado))                          #añado el valor absoluto de la resta a la lista que voy a devolver
                    puntero_Invocante = puntero_Invocante.next              #muevo el puntero de la lista invocante al siguiente nodo
                    puntero_Otra = puntero_Otra.next                        #muevo el puntero de la lista "other" al siguiente nodo

                return l_final #ambas listas están ordenadas, las operaciones se han realizado y se devuelve la lista resultante

                
            return None        #devuelve None porque la lista "other" no está ordenanada

        return None            #devuelve None porque la lista principal no está ordenada
