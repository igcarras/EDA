    ...
    def subtraction(self, other):
        ...
        if (not self.isSorted()) or (not other.isSorted()):
            ...
            if self._head == None and other._head != None:
                self._tail = None
                return other
            elif other._head == None and self._head != None:
                other._tail = None
                return self
            elif self._head == None and other._head == None:
                self._tail = None
                other._tail = None
                return "[]"
            else:
                ...
                while nodeself.next and nodeother.next:

                    if nodeself.elem >= nodeother.elem:
                        e = nodeself.elem - nodeother.elem
                        resultado.append(e)
                    elif nodeself.elem < nodeother.elem:
                        e = nodeother.elem - nodeself.elem
                        resultado.append(e)

                    nodeself = nodeself.next
                    nodeother = nodeother.next

                if nodeself.next == None:
                    self._tail = nodeself

                if nodeother.next == None:
                    other._tail = nodeother
