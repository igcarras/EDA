...
class MySList():
    ...
    def subtraction(self, other):
        ...
        #Comprobamos que las 2 listas estén ordenadas, en caso de que alguna de las 2 no lo esté devolvemos None
        ...
        # Si alguna de las listas está vacía dará como solución la otra, en caso de que amabas estén vacías se devuelve la seguna (que al estar vacía tampoco importa cuál se devuelve)
        if node1 == None:
            solucion = other
            return solucion
        elif node2 == None:
        ...
        # En cualquier otro caso restamos posición por posición y hacemos . append a la solución el valor absoluto de la resta.

        else:
            while node1 or node2:
                if node1 != None and node2 != None:
                    sol = abs(node1.elem - node2.elem)
