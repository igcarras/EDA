...
class MySList():
    ...
    def subtraction(self, other):
        ...
        if self.isSorted() and other.isSorted():
            ...
            if self._head == None and other._head == None: # si las dos
                # listas estan vacias
                return None
            elif self._head != None and other._head == None: # si la lista
                # original no esta vacia y other si
                return self
            elif self._head == None and other._head != None: # si la lista
                # original esta vacia y other no
                return other
            else: # si las dos listas no son vacias
                while current and currentother:
                    if current.elem >= currentother.elem: # para asegurar la
                        # resta sea positiva

                        aux.append(current.elem - currentother.elem)

                    else: # para que sea positiva

                        aux.append(currentother.elem - current.elem)
        ...
        else: # si las listas no estan ordenada
            return None
