...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.l3 = MySList()
        #lista l3 NO esta ordenada y puede tener duplicados
        for i in range(10):
            self.l3.append(random.randint(0, 20))

        self.l4 = MySList()
        # lista l4 NO esta ordenada y puede tener duplicados
        for i in range(6):
            self.l4.append(random.randint(0, 20))

        self.datasubs3 = []
        self.l5 = MySList()
        #lista l5 esta ordenada y tiene duplicados
        for i in range(3):
            self.l5.append(i)
            self.l5.append(i)
        ...
        # lista l6 esta ordenada y no tiene duplicados
