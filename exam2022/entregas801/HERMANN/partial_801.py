...
class MySList():
    ...
    def subtraction(self, other):
        ...
        contador=0
        while cabeza: 
            if cabeza==None or self._tail ==None:
                return None
            else:
                while nuevo or nue:
                    nuevo.append(self._head)
                    nuevo.append(self._tail)     
                    nue.append(self._head) 
                    nue.append(self._tail) 
                    while nuevo or nue:
                        result= self._head.elem - self._head.elem 
                        cabeza= cabeza.next
