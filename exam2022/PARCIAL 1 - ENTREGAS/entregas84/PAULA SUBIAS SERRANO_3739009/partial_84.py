...
class MySList():
    ...
    def merge(self, other):
        ...
        if not self.isSorted() or not other.isSorted():
            ...
            segundo = other._head
            ultimo = None
            while primero or segundo:
                if primero and segundo:
                    if primero.elem == ultimo:
                        primero = primero.next
                    elif segundo.elem == ultimo:
                        segundo = segundo.next
                    elif primero.elem > segundo.elem:
                        ordenada.append(segundo.elem)
                        ultimo = segundo.elem
                        segundo = segundo.next
                    elif primero.elem < segundo.elem:
                        ordenada.append(primero.elem)
                        ultimo = primero.elem
                        primero = primero.next
                    else:
                        ordenada.append(segundo.elem)
