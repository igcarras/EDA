...
class MySList():
    ...
    def subtraction(self, other):
        ...
        if not self.isSorted() or not other.isSorted():
            ...
            lista=MySList()
            node=self._head
            nodeLista=other._head
            while node!=None or nodeLista!=None:
                if node==None:
                    resultado=nodeLista.elem
                elif nodeLista==None:
                    resultado=node.elem
                elif node.elem>=nodeLista.elem:
                    resultado=node.elem-nodeLista.elem
                else:
                    resultado=nodeLista.elem-node.elem
