    ...
    def subtraction(self, other):
        ...
        if self.isSorted() and other.isSorted():
            if self._head == None:
                ...
                Nodo1 = self._head
                Nodo2 = other._head
                while Nodo2 and Nodo1:
                    if Nodo1 and Nodo2.elem == None:
                        Nueva_Lista.append(abs(Nodo1.elem - 0))
                        Nodo1 = Nodo1.next
                    elif Nodo2 and Nodo1.elem == None:
                        Nueva_Lista.append(abs(Nodo2.elem - 0))
                        Nodo2 = Nodo2.next
                    else:
                        Nueva_Lista.append(abs(Nodo1.elem - Nodo2.elem))
                        Nodo1 = Nodo1.next
                        Nodo2 = Nodo2.next
