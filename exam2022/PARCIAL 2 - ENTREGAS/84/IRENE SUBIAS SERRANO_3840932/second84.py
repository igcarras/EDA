...
class MyBinarySearchTree:
    ...
    def removeOutsideRange(self, min: int, max: int) -> []:
        ...
        if self._root is None:
            ...
            self._root = self._removeOutsideRange(self._root, lista, min, max)
            return lista

    def _removeOutsideRange(self, Node, lista, min, max):
        ...
        if Node.left and Node.right is None:
            Node.left = self._removeOutsideRange(Node.left, lista, min, max)
            return Node
        if Node.right and Node.left is None:
            Node.right = self._removeOutsideRange(Node.right, lista, min, max)
            return Node
