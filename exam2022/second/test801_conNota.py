...
class Test(unittest.TestCase):
   ...
   """
    ...
    def test1(self):
      print('Caso 1. Valores min y max fuera de rango de valores de arbol ')
    ...
    def test2(self):
        print('Caso 2. Valores min y max dentro de rango de valores de arbol')
        expected = [18]
        result = self.tree.removeInsideRange(15, 20)
