...
class MySList():
    ...
    def subtraction(self, other):
        ...
        #En primer lugar abarco el caso general#
        i=0
        other=MySList()
        prev1=None
        nodo1=self._head
        ...
        while nodo1 and nodo2:
            #Compruebo que las dos estén ordeandas#
            if self.isSorted() and other.isSorted():
                #Compruebo longitudes#
                if len(self)==len(other):
                    e=(nodo1.elem-nodo2.elem)
                    output.append(e)
                    newNode=SNode(e)
                    output._head=newNode
