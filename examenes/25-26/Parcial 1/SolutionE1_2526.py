...
class MySList():
    ...
    def subtraction(self, other):
        ...
        while node1 and node2:
            if node1.elem <= node2.elem:
                listSubs.append(node2.elem-node1.elem)

            elif node2.elem < node1.elem:
                listSubs.append(node1.elem-node2.elem)
        ...
        while node1:
            listSubs.append(node1.elem)
            node1 = node1.next

        # if the there are still elements in other (list)
        while node2:
            listSubs.append(node2.elem)
            node2 = node2.next
...
if __name__ == '__main__':
    ...
    print('l4:', str(l2))
    print('l5:', str(l3))
    print("List subtraction:", str(l4.subtraction(l5)))
    print("List subtraction:", str(l5.subtraction(l4)))