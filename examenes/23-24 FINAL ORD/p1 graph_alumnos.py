...
class MyGraph:
    ...
    def minDistance_BFS_vAlejandro(self, start: str, end: str) -> int:
        if not self.check_vertex(start):
            print(start, " is not a vertex!!!")
            return
        if not self.check_vertex(end):
        ...
        while len(Q) > 0:
            ...
            for adj in self._vertices.keys():
                if visited[adj] == False:
                    ...
                    Q.append(adj)
                    distances[adj] = distances[w] + 1
                elif distances[w]+1<distances[adj]:
                    distances[adj] = distances[w] + 1
...
if __name__ == '__main__':
    ...
    print()
    print("Solution based on BFS ALEJANDRO:")
    print(g.minDistance_BFS_vAlejandro('A', 'A'))
    print(g.minDistance_BFS_vAlejandro('A', 'B'))
    print(g.minDistance_BFS_vAlejandro('A', 'C'))
    print(g.minDistance_BFS_vAlejandro('A', 'D'))
    print(g.minDistance_BFS_vAlejandro('A', 'E'))
